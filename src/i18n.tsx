...
const translations = {
  ...
  "vpn.store_loading": { ru: "Загрузка списка серверов...", en: "Loading server list..." },
  "vpn.clipboard_empty": { ru: "Буфер обмена пуст", en: "Clipboard is empty" },
  "vpn.server_added": { ru: "Сервер добавлен", en: "Server added" },
  "vpn.server_exists": { ru: "Сервер уже добавлен", en: "Server already exists" },
  "vpn.subscription_loading": { ru: "Загрузка подписки...", en: "Loading subscription..." },
  "vpn.subscription_imported": { ru: "Добавлено серверов", en: "Servers added" },
  "vpn.subscription_empty": { ru: "Поддерживаемые серверы не найдены", en: "No supported servers found" },
  "vpn.clipboard_unsupported": { ru: "Формат ссылки не поддерживается", en: "Unsupported link format" },
  "vpn.import_failed": { ru: "Ошибка импорта", en: "Import failed" },
